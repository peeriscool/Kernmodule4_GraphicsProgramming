...
//additional resource linked on shadertoy: http://blog.hvidtfeldts.net/index.php/2011/09/distance-estimated-3d-fractals-v-the-mandelbulb-different-de-approximations/
out vec4 fragColor;
in vec2 fragCoord;
...
vec3 intersect( in vec3 ro, in vec3 rd )
{
 ...
 { 
	...
	vec3 bg = exp(uv.y-2.0)*vec3(0.4, 0.1f, 1.0) ;
    ...
    // post
    col=pow(clamp(col,0.0,1.0),vec3(0.45)* sin(iTime)); 
